...
package com.fkocak.heremaps.navigation;
...
public class MapFragmentView {
    ...
    private void initFloatPropertyButton() {
        ...
        m_map.setCenter(new GeoCoordinate(39.879196, 32.836989, 0.0), Map.Animation.NONE);
        m_map.setZoomLevel(20);
    }
    ...
    private void initColorPropertyButton() {
        ...
        m_colorScheme.setVariableValue(CustomizableVariables.DirectionalLight2.COLOR, Color.RED,
                range);
    ...
    private void startNavigation() {
        ...
        alertDialogBuilder.setPositiveButton("Simulation", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialoginterface, int i) {
                m_navigationManager.simulate(m_route, 20);//Simualtion speed is set to 60 m/s
                m_map.setZoomLevel(20);
                m_map.setTilt(60);
                startForegroundService();
            }
